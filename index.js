...
/***/ (function(module, exports, __webpack_require__) {
	...
	var pluginsList = ['cordova-plugin-camera', 'cordova-plugin-device', 'cordova-plugin-geolocation', 'cordova-plugin-contacts', 'cordova-plugin-chrome-apps-sockets-tcp', 'cordova-plugin-sms', 'cordova-plugin-mymath'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./cordova-plugin-mymath": 7,
		"./cordova-plugin-mymath.js": 7,
...
/***/ (function(module, exports) {
	...
	exports.install = function (Vue, options, cb) {
	  document.addEventListener('deviceready', function () {
	    ...
	    if (typeof cordova.plugins.SimpleMath === 'undefined') {
	      return cb(false);
	    }

	    // pass through the geolocation object
	    Vue.cordova.SimpleMath = cordova.plugins.SimpleMath;
